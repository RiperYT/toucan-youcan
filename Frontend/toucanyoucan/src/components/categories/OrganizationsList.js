  ...
  return (
    <div className="m-3">
      ...
      <GoPlus
        ...
        className="h-8 w-full self-end bg-accent transition-all hover:cursor-pointer hover:bg-primary rounded-xl border-primary hover:bg-accent hover:text-white"
        color="primary-green"
      />
    </div>
  );
